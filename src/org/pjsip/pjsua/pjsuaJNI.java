...
public class pjsuaJNI {
  ...
  public final static native int PJSUA_SDP_SESS_HAS_CONN_get();
  ...
  public final static native int call_recording_start(int jarg1, long jarg2, pj_str_t jarg2_, int jarg3);
  public final static native int call_recording_stop(int jarg1);
  public final static native int call_recording_status(int jarg1);
