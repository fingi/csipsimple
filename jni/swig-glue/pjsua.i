...
%rename(schedule_timer_dbg) pjsua_schedule_timer_dbg;
%javamethodmodifiers pjsua_schedule_timer_dbg(pj_timer_entry *entry,
                                              const pj_time_val *delay,
                                              const char *src_file,
                                              int src_line) "public synchronized";
...
%rename(ice_config_from_media_config) pjsua_ice_config_from_media_config;
%javamethodmodifiers pjsua_ice_config_from_media_config(pj_pool_t *pool,
                                              pjsua_ice_config *dst,
                                              const pjsua_media_config *src) "public synchronized";
%rename(ice_config_dup) pjsua_ice_config_dup;
%javamethodmodifiers pjsua_ice_config_dup( pj_pool_t *pool,
                                    pjsua_ice_config *dst,
                                    const pjsua_ice_config *src) "public synchronized";
%rename(turn_config_from_media_config) pjsua_turn_config_from_media_config;
%javamethodmodifiers pjsua_turn_config_from_media_config(pj_pool_t *pool,
                                               pjsua_turn_config *dst,
                                               const pjsua_media_config *src) "public synchronized";
%rename(turn_config_dup) pjsua_turn_config_dup;
%javamethodmodifiers pjsua_turn_config_dup(pj_pool_t *pool,
                                    pjsua_turn_config *dst,
                                    const pjsua_turn_config *src) "public synchronized";
